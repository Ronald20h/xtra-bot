...
// =================== DB HELPERS =====================
// =====================================================
const DB_PATH      = path.join(__dirname, 'Json-db', 'Bots');
const PROTECT_PATH = path.join(__dirname, 'protect-data.json');
const PREFIX_PATH  = path.join(__dirname, 'Json-db', 'prefix.json');

[DB_PATH, path.join(__dirname,'Json-db'), path.join(__dirname,'sessions')].forEach(p=>{
